...
@section('content')
	<div class="container">
		...
		@include('layouts.admin.partials._bread')
        
        <div class="row">
			<div class="col-lg-6">
				<div class="card-box">
					<h4 class="m-t-0 m-b-30 header-title"><b>Bar Chart</b></h4>
			...
			<div class="col-lg-6">
				<div class="card-box">
					<h4 class="m-t-0 m-b-30 header-title"><b>Stacked Area Chart</b></h4>
		...
		<div class="row">
			...
			<div class="col-lg-6">
				<div class="card-box">
					<h4 class="m-t-0 m-b-30 header-title"><b>Combine Chart</b></h4>
		...
		<div class="row">
			<div class="col-lg-6">
				<div class="card-box">
					<h4 class="m-t-0 m-b-30 header-title"><b>Scatter Plot</b></h4>
			...
			<div class="col-lg-6">
				<div class="card-box">
					<h4 class="m-t-0 m-b-30 header-title"><b>Line Chart with Regions</b></h4>
